...
namespace OpenIddictOAuth.Infrastructure.Configurations;
...
public static class ConfigurationExtensions
{
    ...
    public static IServiceCollection ReplaceService<TSource, TImplementation>(this IServiceCollection services, ServiceLifetime lifeTime)
    {
        var descriptor = new ServiceDescriptor(typeof(TSource), typeof(TImplementation), ServiceLifetime.Scoped);
